      ...
      {circles.map((_, idx) => (
        <Circle
          style={{
            height: `${(idx + 1) * 5}rem`,
            width: `${(idx + 1) * 5}rem`,
            border: `1px solid rgba(0, 245, 212, ${1 - (idx + 1) * 0.1})`,
          }}
          key={`circle-${idx}`}
          idx={idx}
        />
...
export const IconContainer = ({
  ...
  return (
    ...
    >
      <div className="flex h-12 w-12 items-center justify-center rounded-2xl border border-white/10 bg-slate-900 shadow-[0_0_15px_rgba(0,245,212,0.1)]">
        {icon || (
      ...
      <div className="hidden rounded-md px-2 py-1 md:block bg-slate-950/50 backdrop-blur-sm border border-white/5">
